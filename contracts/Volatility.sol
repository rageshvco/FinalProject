...
import "./libs/CustomErrors.sol";
import "./libs/StochasticGreek.sol";

import "prb-math/contracts/PRBMathSD59x18.sol";
import "prb-math/contracts/PRBMathUD60x18.sol";

/**
 *  @title Smart Contract used as volatility data 
 *  @dev Interacts with liquidity lake to feed in volatility data.
 */
contract VolatilityFeed is AccessControl {
	...
	function _getImpliedVolatility(
		...
		if (!isPut) {
			vol = StochasticGreek.lognormalVol(
				int256(strikePrice),
				forwardPrice,
				time,
